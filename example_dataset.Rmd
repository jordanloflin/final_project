...
I compiled my dataset using several sources found at the web site of the nonprofit [Death Penalty Information Center](https://deathpenaltyinfo.org/). 

The dataset was last updated January 7, 2022, so some of the values may have changed between that date and now. 
...
```{r}
data <- read_csv("data/cappunish20220107.csv")
```
...
This is a servicable plot, but kind of bland, right?
